...
public class DeathScreen : MonoBehaviour
{
    ...
    [SerializeField] private float fogIntensity = 5f;
    ...
    private void Start()
    {
        ...
        enemyMoveDir = Vector3.Normalize(Camera.main.transform.position - enemy.position);
    ...
    private void Update()
    {
        ...
        if(Vector3.Distance(enemy.position, Camera.main.transform.position) > frameDst)
        {
